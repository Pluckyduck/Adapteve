...
namespace AdapteveDLL
{
    public class Main : IEntryPoint
    {
        ...
        public void InitializeHooks()
        {
            ...
            _hooks.Add(new WinsockHook(LocalHook.GetProcAddress("WS2_32.dll", "connect"), settings));
            _hooks.Add(new GraphicsCardHook(settings));
            _hooks.Add(new GraphicsCardDX9Hook(settings));
